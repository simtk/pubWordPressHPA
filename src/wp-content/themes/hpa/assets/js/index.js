...
var flickityAsNavFor = require('flickity-as-nav-for');
...
$(document).ready(function () {
  ...
  initNav();
  initNewsListing();
  initOrganizationListing();
  initPeopleListing();
  initStyledListing();
  initTabbedContent();
  sectionDivider();
  angledBackgroundZ();
  fitVids('.basic-content__wysiwyg-content');
  fitVids('.content-with-visual__visual');
  fitVids('.gallery__visual');
  fitVids('.columned-content__column');
  objectFitImages();
  objectFitVideos();
  cssVars();
  $('.card__content').matchHeight();
  $('.people-listing__name').matchHeight();
  $('.wysiwyg-content').each(function () {
    $(this).find('.eyebrow').parent().addClass('wysiwyg-parent--eyebrow');
    $(this).find('.large-text').parent().addClass('wysiwyg-parent--large-text');
    $(this).find('.small-text').parent().addClass('wysiwyg-parent--small-text');
    $(this).find('.button').parent().addClass('wysiwyg-parent--button');
    $(this).find('.red-headline').parent().addClass('wysiwyg-parent--red-headline');
    $(this).find('.green-headline').parent().addClass('wysiwyg-parent--green-headline');
    $(this).find('.citation').parent().addClass('wysiwyg-parent--citation');
...
function initCarousel() {
  var carousel = $('.carousel__carousel-wrapper').flickity({
    fade: true,
    wrapAround: true,
    setGallerySize: $(window).width() > 991 ? false : true,
    draggable: false,
    pageDots: false,
    arrowShape: {
      x0: 10,
...
function initGallery() {
  $('.gallery').each(function () {
    var spotlight = $(this).find('.gallery__visual-spotlight-container');
    var nav = $(this).find('.gallery__visual-navigator-container');
    spotlight.flickity({
      fade: true,
      pageDots: false,
...
function initHero() {
  $('.hero__modal-cta').on('click', function () {
    var video = $(this).siblings('.hero__modal-video').html();
    $.featherlight(video, {
      afterOpen: function afterOpen() {
        fitVids('.featherlight-content');
      }
    });
  });
}
...
function initNav() {
  $('.site-header__hamburger').on('click', function () {
    ...
    var bannerHeight = $('.additional-header').outerHeight(); // $('.site-header__utility-navigation').css('')

    $('.site-header__utility-navigation').toggleClass('active');

    if ($(window).width() < 768 && $('.site-header__utility-navigation').hasClass('active')) {
      $('body').addClass('fixed');
    }
  });
  $('.site-header__utility-close i').on('click', function () {
    $('.site-header__utility-navigation').removeClass('active');
...
function initNewsListing() {
  $('.news-listing__load-more').on('click', function (e) {
    e.preventDefault();
    var hiddenChildren = $(this).closest('.news-listing__list').find('.card.hidden');
    var postsPerPage = $(this).closest('.news-listing__list').attr('data-posts-per-page');
    hiddenChildren.each(function (index, ele) {
      if (postsPerPage - 1 >= index) {
        $(this).removeClass('hidden');
      }
    });
    hiddenChildren = $(this).closest('.news-listing__list').find('.card.hidden');
...
function initOrganizationListing() {
  var simple = $('.organizations-listing--style-simple').find('.organizations-listing__list');
  var tallestOrg = 0;
  var $carousel = simple.flickity({
    cellAlign: 'left',
    pageDots: false,
    // contain: true,
    watchCSS: true,
  ...
  $('.organizations-listing--style-simple .flickity-enabled').find('.organizations-listing__image img').each(function () {
    if ($(this).outerHeight() > tallestOrg) {
      tallestOrg = $(this).outerHeight();
    }
  });
  $('.organizations-listing--style-simple .flickity-enabled').find('.organizations-listing__org').each(function () {
    $(this).css('min-height', tallestOrg);
  });
  $carousel.flickity('resize');
}

function initPeopleListing() {
  $('.people-listing').each(function () {
    var intro = $(this).find('.people-listing__section-intro');

    if (intro.children().last().hasClass('left-rule-style')) {
      intro.addClass('last-child-has-rule');
    }
  });
}

function initStyledListing() {
  styled_listing_cards_match_height();
  window.addEventListener('resize', styled_listing_cards_match_height_onResize);
  setTimeout(function () {
    $('.styled-listing__card').addClass('no-max-height');
  }, 50);
  $('.styled-listing__card').hover(function () {
    if (window.innerWidth > 767) {
      var content = $(this).find('.styled-listing__wysiwyg-content');
      var height = content[0].scrollHeight;
      content.css('max-height', height);
  ...
  $('.styled-listing__card').click(function (e) {
    if (window.innerWidth <= 767) {
      var content = $(this).find('.styled-listing__wysiwyg-content');
      var height = content[0].scrollHeight;
      $(this).toggleClass('active');
...
function styled_listing_cards_match_height() {
  try {
    $('.styled-listing__card').each(function (index) {
      var padding_top = parseInt($(this).css('padding-top'));
      var padding_bottom = parseInt($(this).css('padding-bottom'));
      var title_height = $(this).find('.styled-listing__title')[0].scrollHeight;
      var content_height = $(this).find('.styled-listing__wysiwyg-content')[0].scrollHeight;
      var card_height = padding_top + padding_bottom + title_height + content_height + 1;
      $(this).height(card_height);
    });
  } catch (error) {
    console.log('Error setting card heights:');
    console.log(error);
  }

  try {
    $('.styled-listing__card').matchHeight();
  } catch (error) {
    console.log('Error with matchHeight():');
    console.log(error);
  }
}

function styled_listing_cards_match_height_onResize() {
  debounce(styled_listing_cards_match_height(), 100);
}

function initTabbedContent() {
  $('.tabbed-content__title').on('click', function () {
    $('.tabbed-content__title.active, .tabbed-content__wysiwyg-content.active').removeClass('active');
    $(this).addClass('active');
    var parent = $(this).closest('.tabbed-content');
    var titleNum = $(this).attr('data-title-num');
    parent.find('.tabbed-content__wysiwyg-content[data-content-num="' + titleNum + '"]').addClass('active');
  });
  var tabbedCarousel = $('.tabbed-content__titles').flickity({
    adaptiveHeight: true,
    cellAlign: 'center',
    pageDots: false,
    watchCSS: true
  });
  var carouselParent = tabbedCarousel.closest('.tabbed-content');
  tabbedCarousel.on('change.flickity', function (event, index) {
    $('.tabbed-content__title.active, .tabbed-content__wysiwyg-content.active').removeClass('active');
    console.log(index + 1);
    carouselParent.find('.tabbed-content__title[data-title-num="' + (index + 1) + '"]').addClass('active');
    carouselParent.find('.tabbed-content__wysiwyg-content[data-content-num="' + (index + 1) + '"]').addClass('active');
  });
} // adjustLogoSizes();


function adjustLogoSizes() {
  $('.organizations-listing--style-simple .organizations-listing__image img').each(function () {
    adjustImageWidth($(this)[0]);
  });
  ...
  function adjustImageWidth(image) {
    ...
    $(image).css('width', Math.pow(imageRatio, scaleFactor) * widthBase);
  }
}
...
function sectionDivider() {
  // check to see if section before and after divider have the same background
  // or if prev is gray/light angle followed by a white background
  $('.page-section--section-divider').each(function () {
    var _this = $(this),
        prev = false,
        next = false;

    if (_this.prev().hasClass('page-section--background-gray-angled') || _this.prev().hasClass('page-section--background-light-color-angled')) {
      prev = true;
    }

    if (_this.next().hasClass('page-section--background-white')) {
      next = true;
    }

    if (prev == true && next == true) {
      _this.addClass('section-divider--negative-margin');
    }
  });
}

function angledBackgroundZ() {
  if ($('.page-section--background-gray-angled').length) {
    var indexLimit = $('.page-section--main').children().length;
    $('.page-section--main').children().each(function () {
      $(this).addClass('z-index z-index--' + indexLimit);
      indexLimit--;
    });
  }
}

},{"./libs/featherlight.js":2,"./libs/matchHeight.js":3,"css-vars-ponyfill":4,"fitvids":7,"flickity":16,"flickity-as-nav-for":9,"flickity-fade":10,"jquery":24,"jquery-bridget":23,"object-fit-images":25,"object-fit-videos":26}],2:[function(require,module,exports){
"use strict";
...
},{"desandro-matches-selector":5}],9:[function(require,module,exports){
/*!
...
},{"fizzy-ui-utils":8,"flickity":16}],10:[function(require,module,exports){
/**
...
},{"fizzy-ui-utils":8,"flickity":16}],11:[function(require,module,exports){
// add, remove cell
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
...
},{"./flickity":15,"fizzy-ui-utils":8}],12:[function(require,module,exports){
// animate
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
...
},{"fizzy-ui-utils":8}],13:[function(require,module,exports){
// Flickity.Cell
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
...
},{"./flickity":15,"fizzy-ui-utils":8,"unidragger":27}],15:[function(require,module,exports){
// Flickity main
...
},{"./animate":12,"./cell":13,"./slide":21,"ev-emitter":6,"fizzy-ui-utils":8,"get-size":22}],16:[function(require,module,exports){
/*!
 * Flickity v2.2.2
...
},{"./flickity":15,"fizzy-ui-utils":8}],18:[function(require,module,exports){
// page dots
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
...
},{"./flickity":15,"fizzy-ui-utils":8,"unipointer":28}],19:[function(require,module,exports){
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
...
},{"./flickity":15,"ev-emitter":6,"fizzy-ui-utils":8}],20:[function(require,module,exports){
// prev/next buttons
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
...
},{"./flickity":15,"fizzy-ui-utils":8,"unipointer":28}],21:[function(require,module,exports){
// slide
( function( window, factory ) {
  // universal module definition
  if ( typeof define == 'function' && define.amd ) {
